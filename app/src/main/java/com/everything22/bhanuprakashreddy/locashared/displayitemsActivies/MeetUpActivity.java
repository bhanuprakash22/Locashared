...
public class MeetUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            try {
                getSupportActionBar().setTitle(" Meet Ups ");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (user == null){
                    Intent i = new Intent(MeetUpActivity.this,SignupActivity.class);
                    startActivity(i);
                }else{
                    startActivity(new Intent(MeetUpActivity.this,PostActivity.class));
                }
            }
        };

        mEvent_List=(RecyclerView)findViewById(R.id.meetup_Recyclerview);
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("MeetUps");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<EventEducationModel,meetViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<EventEducationModel, meetViewHolder>(
                EventEducationModel.class,
                R.layout.meetup_custom_cardview,
                meetViewHolder.class,
                mDatabaseRef

        ) {
            @Override
            protected void populateViewHolder(meetViewHolder viewHolder, EventEducationModel model, final int position) {
                ...
                viewHolder.mview.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent next = new Intent(MeetUpActivity.this, SinglePostViewActivity.class);
                        next.putExtra("items",Post_Key);
                        next.putExtra("Key1","MeetUps");
                        startActivity(next);
                    }
                });
            }
    ...
    public static class  meetViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setEvent_Name(String event_Name) {
            TextView post_title = (TextView)mview.findViewById(R.id.m_title);
            post_title.setText(event_Name);
        }

        public void setEvnt_desc(String evnt_desc) {
            TextView post_desc = (TextView)mview.findViewById(R.id.m_desc);
            post_desc.setText(evnt_desc);
        }

        public void setEvent_location(String event_location){
            TextView post_location = (TextView)mview.findViewById(R.id.m_location);
            post_location.setText(event_location);
        }

        public void setImage(final Context ctx, final String image) {
            final ImageView post_image = (ImageView)mview.findViewById(R.id.m_image_recycle);
