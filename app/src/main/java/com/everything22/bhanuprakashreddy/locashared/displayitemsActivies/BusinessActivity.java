...
public class BusinessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (user == null){
                    Intent i = new Intent(BusinessActivity.this,SignupActivity.class);
                    startActivity(i);
                }else{
                    startActivity(new Intent(BusinessActivity.this,PostActivity.class));
                }
            }
        };

        mEvent_List=(RecyclerView)findViewById(R.id.Business_Recyclerview);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<EventEducationModel,BusinessViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<EventEducationModel, BusinessViewHolder>(
                EventEducationModel.class,
                R.layout.business_custom_cardview,
                BusinessViewHolder.class,
                mDatabaseRef

        ) {
            @Override
            protected void populateViewHolder(BusinessViewHolder viewHolder, EventEducationModel model, final int position) {
               ...
               viewHolder.setEvent_Name(model.getEvent_Name());
                ...
                viewHolder.mview.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent next = new Intent(BusinessActivity.this, SinglePostViewActivity.class);
                        next.putExtra("items",Post_Key);
                        next.putExtra("Key1","Business");
                        startActivity(next);
                    }
                });
            }
    ...
    public static class BusinessViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setEvent_Name(String event_Name) {
            TextView post_title = (TextView)mview.findViewById(R.id.b_title);
            post_title.setText(event_Name);
        }

        public void setEvnt_desc(String evnt_desc) {
            TextView post_desc = (TextView)mview.findViewById(R.id.b_desc);
            post_desc.setText(evnt_desc);
        }

        public void setEvent_location(String event_location){
            TextView post_location = (TextView)mview.findViewById(R.id.b_location);
            post_location.setText(event_location);
        }

        public void setImage(final Context ctx, final String image) {
            final ImageView post_image = (ImageView)mview.findViewById(R.id.b_image_recycle);
