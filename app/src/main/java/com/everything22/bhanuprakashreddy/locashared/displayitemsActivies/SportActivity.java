...
public class SportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (user == null){
                    Intent i = new Intent(SportActivity.this,SignupActivity.class);
                    startActivity(i);
                }else{
                    startActivity(new Intent(SportActivity.this,PostActivity.class));
                }
            }
        };

        mEvent_List=(RecyclerView)findViewById(R.id.sport_Recyclerview);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<EventEducationModel,SportViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<EventEducationModel, SportViewHolder>(
                EventEducationModel.class,
                R.layout.sport_custom_cardview,
                SportViewHolder.class,
                mDatabaseRef

        ) {
            @Override
            protected void populateViewHolder(SportViewHolder viewHolder, EventEducationModel model, final int position) {
                ...
                viewHolder.mview.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent next = new Intent(SportActivity.this, SinglePostViewActivity.class);
                        next.putExtra("items",Post_Key);
                        next.putExtra("Key1","Sports");
                        startActivity(next);
                    }
                });
            }
    ...
    public static class  SportViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setEvent_Name(String event_Name) {
            TextView post_title = (TextView)mview.findViewById(R.id.s_title);
            post_title.setText(event_Name);
        }

        public void setEvnt_desc(String evnt_desc) {
            TextView post_desc = (TextView)mview.findViewById(R.id.s_desc);
            post_desc.setText(evnt_desc);
        }

        public void setEvent_location(String event_location){
            TextView post_location = (TextView)mview.findViewById(R.id.s_location);
            post_location.setText(event_location);
        }

        public void setImage(final Context ctx, final String image) {
            final ImageView post_image = (ImageView)mview.findViewById(R.id.s_image_recycle);
