...
public class HealthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (user == null){
                    Intent i = new Intent(HealthActivity.this,SignupActivity.class);
                    startActivity(i);
                }else{
                    startActivity(new Intent(HealthActivity.this,PostActivity.class));
                }
            }
        };

        mEvent_List=(RecyclerView)findViewById(R.id.health_Recyclerview);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<EventEducationModel,HealthViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<EventEducationModel, HealthViewHolder>(
                EventEducationModel.class,
                R.layout.health_custom_cardview,
                HealthViewHolder.class,
                mDatabaseRef

        ) {
            @Override
            protected void populateViewHolder(HealthViewHolder viewHolder, EventEducationModel model, final int position) {
                ...
                viewHolder.mview.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent next = new Intent(HealthActivity.this, SinglePostViewActivity.class);
                        next.putExtra("items",Post_Key);
                        next.putExtra("Key1","Health");
                        startActivity(next);
                    }
                });
            }
    ...
    public static class  HealthViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setEvent_Name(String event_Name) {
            TextView post_title = (TextView)mview.findViewById(R.id.h_title);
            post_title.setText(event_Name);
        }

        public void setEvnt_desc(String evnt_desc) {
            TextView post_desc = (TextView)mview.findViewById(R.id.h_desc);
            post_desc.setText(evnt_desc);
        }

        public void setEvent_location(String event_location){
            TextView post_location = (TextView)mview.findViewById(R.id.h_location);
            post_location.setText(event_location);
        }

        public void setImage(final Context ctx, final String image) {
            final ImageView post_image = (ImageView)mview.findViewById(R.id.h_image_recycle);
