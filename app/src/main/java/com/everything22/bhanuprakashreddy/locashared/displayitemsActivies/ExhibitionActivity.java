...
public class ExhibitionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (user == null){
                    Intent i = new Intent(ExhibitionActivity.this,SignupActivity.class);
                    startActivity(i);
                }else{
                    startActivity(new Intent(ExhibitionActivity.this,PostActivity.class));
                }
            }
        };

        mEvent_List=(RecyclerView)findViewById(R.id.exhibition_Recyclerview);
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("Exhibitions");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<EventEducationModel,ExhibitionViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<EventEducationModel, ExhibitionViewHolder>(
                EventEducationModel.class,
                R.layout.exhibition_custom_cardview,
                ExhibitionViewHolder.class,
                mDatabaseRef

        ) {
            @Override
            protected void populateViewHolder(ExhibitionViewHolder viewHolder, EventEducationModel model, final int position) {
                ...
                viewHolder.mview.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent next = new Intent(ExhibitionActivity.this, SinglePostViewActivity.class);
                        next.putExtra("items",Post_Key);
                        next.putExtra("Key1","Exhibitions");
                        startActivity(next);
                    }
                });
            }
    ...
    public static class  ExhibitionViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setEvent_Name(String event_Name) {
            TextView post_title = (TextView)mview.findViewById(R.id.e_title);
            post_title.setText(event_Name);
        }

        public void setEvnt_desc(String evnt_desc) {
            TextView post_desc = (TextView)mview.findViewById(R.id.e_desc);
            post_desc.setText(evnt_desc);
        }

        public void setEvent_location(String event_location){
            TextView post_location = (TextView)mview.findViewById(R.id.e_location);
            post_location.setText(event_location);
        }

        public void setImage(final Context ctx, final String image) {
            final ImageView post_image = (ImageView)mview.findViewById(R.id.e_image_recycle);
